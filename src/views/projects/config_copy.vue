    ...
    <div class="nav">
      ...
      >
        <el-submenu index="1">
          ...
          <draggable @change="log" :list="layouts" class="layouts"
        ...
        <el-submenu index="2">
          ...
          <draggable :list="brick.fields" class="fields" group="fields">
              ...
              <el-row>
                <div v-for="col of row.cols" :key="col.id">
                  <el-col :span="row.span">
                    <draggable :list="col.fields" group="fields" class="cols" @change="log">
                      放到此处
