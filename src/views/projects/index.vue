  ...
  <div class="app-container">
    ...
    <y-table :table-data="tableData" :pagination="pagination" @changePage4List="getList">
      <template>
        ...
        <el-table-column prop="cnname" label="中文名" width="200px" />
        <el-table-column prop="description" label="简介" />

        <el-table-column label="操作" width="200px">
          <template slot-scope="{row}">
            <el-button type="text" size="small" @click="go(row.id)">进入</el-button>
...
export default {
  ...
  methods: {
    ...
    go(id) {
      this.$router.push({ path: 'bricks', query: { id: id }})
    },
    add() {
